 ...
 */
public class fragment_hanoi extends Fragment {
    private TextView main;
    private TextView description;
    private TextView temp;
    private TextView speed;
    private SharedPreferences dataHanoi ;
...
//            Toast.makeText(MainActivity.this, "dis cụ - nó vào rồi!", Toast.LENGTH_LONG).show();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hanoi_fragment,container,false);
        ...
        if(isConneted()){
            ...
            sharedPreferences_hanoi = this.getActivity().getSharedPreferences(NAME_HANOI,  Context.MODE_PRIVATE);
            editor_hanoi = sharedPreferences_hanoi.edit();
        }


        dataHanoi = this.getActivity().getSharedPreferences(MainActivity.NAME_HANOI, Context.MODE_PRIVATE);

        String main_s = dataHanoi.getString(MainActivity.KEY_VALUE_MAIN,"");
        String description_s = dataHanoi.getString(MainActivity.KEY_VALUE_DES,"");
        String temp_s = dataHanoi.getString(MainActivity.KEY_VALUE_TEMP,"");
        String speed_s =dataHanoi.getString(MainActivity.KEY_VALUE_SPEED,"");
