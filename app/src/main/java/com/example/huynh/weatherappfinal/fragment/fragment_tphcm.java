 ...
 */
public class fragment_tphcm extends Fragment {
    private TextView main;
    private TextView description;
    private TextView temp;
    private TextView speed;
    private SharedPreferences dataHcm;

    private SharedPreferences sharedPreferences_hcm;
    private SharedPreferences.Editor editor_hcm;
    ...
    public static final String NAME_HCM = "HuynhDuc_hcm";


    public fragment_tphcm(){
...
//            Toast.makeText(MainActivity.this, "dis cụ - nó vào rồi!", Toast.LENGTH_LONG).show();
            ...
            if (isConneted()) {
                ...
                editor_hcm.putString(KEY_VALUE_MAIN, main);
                editor_hcm.putString(KEY_VALUE_DES, description);
                editor_hcm.putString(KEY_VALUE_TEMP, temp);
                editor_hcm.putString(KEY_VALUE_SPEED, speed);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tphcm_fragment,container,false);
        ...
        if(isConneted()){
            ...
            downloadJSon.execute(API + "?q=Hochiminh&&APPID=" + API_KEY);
            //save in SharePreferences
            sharedPreferences_hcm = this.getActivity().getSharedPreferences(NAME_HCM,  Context.MODE_PRIVATE);
            editor_hcm = sharedPreferences_hcm.edit();
        ...
        dataHcm = this.getActivity().getSharedPreferences(NAME_HCM, Context.MODE_PRIVATE);

        String main_s = dataHcm.getString(MainActivity.KEY_VALUE_MAIN,"");
        String description_s = dataHcm.getString(MainActivity.KEY_VALUE_DES,"");
        String temp_s = dataHcm.getString(MainActivity.KEY_VALUE_TEMP,"");
        String speed_s = dataHcm.getString(MainActivity.KEY_VALUE_SPEED,"");
